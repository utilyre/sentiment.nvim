...
describe("`:diff()`", function()
  it("works when `vp1` is slightly behind `vp2`", function()
  ...
  it("works when `vp1` is slightly ahead `vp2`", function()
  ...
  it("works when `vp1` contains `vp2`", function()
  ...
  it("works when `vp1` is contained by `vp2`", function()
...
describe("`:split()`", function()
  it("works when `Viewport`'s length is divisible by the given `n`", function()
  ...
  it(
    "works when `Viewport`'s length is not divisible by the given `n`",
    function()
